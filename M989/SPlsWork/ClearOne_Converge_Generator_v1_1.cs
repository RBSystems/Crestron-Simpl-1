...
namespace UserModule_CLEARONE_CONVERGE_GENERATOR_V1_1
{
    public class UserModuleClass_CLEARONE_CONVERGE_GENERATOR_V1_1 : SplusObject
    {
...
public UserModuleClass_CLEARONE_CONVERGE_GENERATOR_V1_1 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
