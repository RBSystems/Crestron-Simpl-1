...
namespace UserModule_KEYPROA
{
    public class UserModuleClass_KEYPROA : SplusObject
    {
...
public UserModuleClass_KEYPROA ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
